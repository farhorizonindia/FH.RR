...
public partial class ClientUI_FHCruiseReport : ClientBasePage
{
    ...
    protected void ExportToExcel()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=CruiseBookingReport.xls");
        Response.Charset = "";
