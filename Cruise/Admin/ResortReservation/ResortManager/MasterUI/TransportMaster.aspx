<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransportMaster.aspx.cs" Inherits="MasterUI_TransportMaster" %>
...
<body>
    ...
    <phc:PageHeaderControl id="pageheader1" runat="server" PageTitle="Transport Master" />    
    <div>
           <asp:ScriptManager ID="scmgrTransport" runat="server">
            </asp:ScriptManager>
            <asp:UpdatePanel ID="pnlTransport" runat="server">
                <ContentTemplate>                    
                    <div id="gridsection" class="gridsection">
                            <asp:DataGrid ID="dgTransport" runat="server" AutoGenerateColumns="False" BorderStyle="Ridge"
                                CellPadding="4" DataKeyField="TransportId" ForeColor="#333333" GridLines="None"
                                OnSelectedIndexChanged="dgTransport_SelectedIndexChanged" Width="391px" AllowPaging="True" OnPageIndexChanged="dgTransport_PageIndexChanged">
                                ...
                                <Columns>
                                    <asp:BoundColumn DataField="TransportName" HeaderText="Transport"></asp:BoundColumn>
                    ...
                    <tr>
                        ...
                        <td style="width: 180px">
                            <asp:TextBox cssclass="input"  ID="txtTransport" runat="server" Width="170px"></asp:TextBox></td>
                    </tr>
                    </table>                        
