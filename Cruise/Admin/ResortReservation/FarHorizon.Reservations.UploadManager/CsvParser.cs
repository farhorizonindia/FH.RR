...
namespace FarHorizon.Reservations.UploadManager
{
    internal class CsvParser
    {
        ...
        //and expecting a header line in the CSV source or not. 
        //Only one method has a real body, all others just adjust their parameter signature. 
        //The implementation is simple: the method reads one "row" of the CSV source at a time 
        //and populates a row in the DataTable. 
        //The real meat is the private class CsvStream explained below. 
        ...
        //read the CSV source in one character at a time and return meaningful chunks of decoded data, 
