   ...
   <ContentTemplate>
    ...
    <table id="inputsection" class="inputsection">
        ...
        <tr>
            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">
                Room Type:</td>
            <td style="height: 11px; width: 228px;">
        ...
        <tr>
            <td style="font-size: 8pt; width: 91px; height: 18px; text-align: left">
                Extra Beds:</td>
            <td style="width: 228px"><asp:DropDownList cssclass="select" ID="ddlExtraBeds" runat="server" Width="95px" TabIndex="8" AutoPostBack="True" OnSelectedIndexChanged="ddlExtraBeds_SelectedIndexChanged" Font-Size="8pt">
            </asp:DropDownList></td>
            <td style="font-size: 8pt; width: 91px; height: 18px; text-align: left">
                Extra Bed Rate:</td>
            <td>
