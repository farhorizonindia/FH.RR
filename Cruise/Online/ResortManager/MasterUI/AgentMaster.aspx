...
<body>
    ...
    <div id="gridsection" class="gridsection">
        ...
        DataKeyField="AgentID" ForeColor="#333333" GridLines="None" OnDeleteCommand="dgAgents_DeleteCommand"
        OnSelectedIndexChanged="dgAgents_SelectedIndexChanged" Width="525px" BorderStyle="Ridge">
