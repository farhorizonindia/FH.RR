    ...
    protected void dgBookings_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            if (CForm)
            {
                ...
                {
                    dgBookings.Columns[12].Visible = true;
                    e.Item.Cells[12].Text = "No Tourists";
                    dgBookings.Columns[13].Visible = false;
                }

                dgBookings.Columns[12].Visible = e.Item.Cells[16].Text.ToUpper() == Boolean.TrueString.ToUpper() ? true : false;
                dgBookings.Columns[13].Visible = e.Item.Cells[17].Text.ToUpper() == Boolean.TrueString.ToUpper() ? true : false;
            }
            else
            {
