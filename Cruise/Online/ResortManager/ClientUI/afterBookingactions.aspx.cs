...
public partial class ClientUI_afterBookingactions : ClientBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (status == "confirmed")
            {
                ...
                {
                    BookDetailsformail(iBookingId, "");
                    Bookconfirmformail(iBookingId, "");
                }
                else
                {
                    BookDetailsformail(iBookingId, "");
                    BookingDTO[] objcon = Session["confirmDet"] as BookingDTO[];
                    PrepareConfirmMail(objcon, "Previous Details");

                    Bookconfirmformail(iBookingId, "Updated Details");
            ...
            if ((status == "waitlisted" || status == "booked") && updated == false)
            {
                ...
                BookDetailsformail(iBookingId, "");
                BookingRoomDetailsformail(iBookingId,"");
            }
            if ((status == "waitlisted" || status == "booked") && updated == true)
            {
                ...
                PrepareRoomBookingReport(orrbd, "Previous Details");
                BookingRoomDetailsformail(iBookingId, "Updated Details");
            }
    ...
    private void Bookconfirmformail(int bookingId, string st)
    {
        BookingDTO[] obd = null;
        ...
        if (obd != null)
        {
            if (obd != null)
            {
                PrepareConfirmMail(obd, st);
            }
        }

    }

    private void PrepareConfirmMail(BookingDTO[] obd, string st)
    {
        Table tblMain = new Table();
        TableRow tr;
        TableCell tc;
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = string.Format(obd[0].ArrivalDateTime.ToString(), "0:dd-MMM-yyyy");
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = string.Format(obd[0].DepartureDateTime.ToString(), "0:dd-MMM-yyyy");
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalTransport.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureTransport.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalVehicleNo.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureVehicleNo.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalVehicleNameType.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureVehicleNameType.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalTransportCompany.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureTransportCompany.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalTransportCompanyPhoneNo.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureTransportCompanyPhoneNo.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].ArrivalDriverPhoneNo.ToString();
        ...
        tr.Cells.Add(tc);
        tc = new TableCell();
        tc.Text = obd[0].DepartureDriverPhoneNo.ToString();
    ...
    private void BookDetailsformail(int bookingId, string st)
    {
        ...
        if (obd != null)
        {
            if (obd.Length > 0)
            {
                PrepareBookindDetailsMail(obd, st);
            }
        }

    }

    private void BookingRoomDetailsformail(int bookingid,string st)
    {
        BookingRoomReportsDTO[] oBRRD = null;
        BookingReportServices oBRM = new BookingReportServices();
        ...
        if (oBRRD != null)
        {
            if (oBRRD.Length > 0)
            {
                PrepareRoomBookingReport(oBRRD,st);
            }
        }
    }

    private void PrepareRoomBookingReport(BookingRoomReportsDTO[] BookingRoomReportsDTO,string st)
    {
    ...
    private void PrepareBookindDetailsMail(BookingDTMail[] BookingDTMail, string st)
    {
