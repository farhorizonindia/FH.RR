    ...
    <table>
            <tr>
                <td colspan="2" style="width: 550px">
                   ...
                   <table>
                   <tr>
                       <td><asp:Label ID="lblBookingStatus" runat="server"></asp:Label></td></tr>
                       <tr>
                       <td><asp:Label ID="lblBookingDetails" runat="server"></asp:Label></td></tr>
                       <tr><td><asp:Label ID="lblComment" runat="server"></asp:Label></td>
                   </tr>
                   </table>
                   </asp:Panel>
                </td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <br />
                    <asp:Label ID="Label1" runat="server" Text="Dear Sir/Madam,"></asp:Label>
                    <br />
