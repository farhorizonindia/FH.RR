            ...
            <ContentTemplate>
                <div id="RightColumn" class="RightColumn" style="float: left; width: 765px">
                    <div id="inputsection" class="inputsection">
                        <div id="bookingRef_UIElement" style="float: left; width: 290px;">
                            <div id="bookingRefLabel" class="bookingRefLabel">
                                Booking Ref.:</div>
                            <asp:TextBox ID="txtBookingRef" CssClass="bookingRefInputBox" runat="server" MaxLength="50"></asp:TextBox>
                        </div>
