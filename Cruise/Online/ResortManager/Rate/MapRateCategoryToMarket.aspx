<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MapRateCategoryToMarket.aspx.cs" Inherits="Rate_MapRateCategoryToMarket" %>
...
<head id="Head1" runat="server">
    <title>Map Rate To Market</title>
...
<body>
    <form id="form1" runat="server">
        <phc:PageHeaderControl ID="pageheader1" runat="server" PageTitle="Map Market To Rate Category" />
        <br />
        <div>
