...
<head runat="server">
    ...
    <style>
        ...
        /*th
        {
            ...
            .CSSTableGenerator td
            {
                ...
                font-family: Arial;
                font-weight: normal;
                color: #000000; border-color:#000 !important; border:1px solid #000;
            }
    ...
    font-size:medium;
		...
		h2{ font-size:25px; text-align:center; line-height:44px; margin-bottom:30px;}
		
		#pnlRooms table{ margin:0 auto; float:none;}
		
		input submit{background-color: #2492E2 !important;
    border: solid 1px #2492E2 !important; display: inline-block;
    padding: 6px 12px;
    margin-bottom: 0;
    font-size: 14px;
    font-weight: 400;
...
<body class="bg-img-H">
    <form id="form1" runat="server">
        ...
        <div class="col-md-12 White-Box text-center">
            <h2>Booking Details<samp class=" pull-right"> <asp:LinkButton ID="lnkLogout" runat="server" CssClass="button-link" OnClick="lnkLogout_Click">Logout</asp:LinkButton></samp></h2>
    ...
    <div style="display:none">
     ...
     <div class=" clear"></div>
        <div id="DivContinue" class=" btn-summerised" >
          ...
          <asp:Button  runat="server" CssClass="btn btn-info btnWidth100 btnFont" ID="btnBack" Text="Back" OnClick="btnBack_Click"/>  <asp:Button CssClass="btn btn-info btnWidth100 btnFont" runat="server" ID="btnSmbt" Text="Proceed" OnClick="btnSmbt_Click" />
        </div>
           ...
           <asp:Panel ID="customerLogin" runat="server" style="margin-top: 30px;">
               ...
               <table id="TableCust" runat="server" style="margin:30px auto; float:none;">
                   ...
                   <tr>
                       ...
                       <td><asp:TextBox ID="txtCustMailId" runat="server"></asp:TextBox></td>
                   ...
                   <tr>
                       ...
                       <td><asp:TextBox ID="txtCustPass" runat="server" TextMode="Password"></asp:TextBox>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <div id="formTop" class="row noSideMargin backgroundPaperDark innerDropShadow topbotPadding">
                    ...
                    <table style=" margin:0 auto; float:none; width: 51%;">
                        <tr>
                            <td>       <label for="ddlTitle" class="control-label">Title</label></td>
                            <td>
                        ...
                        <tr>
                            <td> <label for="txtName" class="control-label">Firstname</label></td>
                            <td>
                        ...
                        <tr>
                            <td>  <label for="txtName" class="control-label">Lastname</label></td>
                            <td>
                     ...
                     <tr>
                         <td>    <label for="txtEmailAddress" class="control-label">Email Address</label></td>
                         <td>
                        ...
                        <tr>
                            <td>    <label for="txtEmailAddress" class="control-label">Telephone</label></td>
                            <td>
                        ...
                        <tr>
                            <td>  <label for="txtAddress2" class="control-label">Address 2</label></td>
                            <td> <asp:TextBox ID="txtaddress2" runat="server" class="form-control" style="margin-bottom:15px"></asp:TextBox></td>


                        </tr>

                        <tr>
                         <td>    <label for="txtCity" class="control-label">City</label></td>
                         <td>
                        ...
                        <tr>
                            <td>   <label for="txtState" class="control-label">State</label></td>
                            <td> <asp:TextBox ID="txtState" runat="server" class="form-control"></asp:TextBox>
                        ...
                        <tr>
                            <td>    <label for="txtPostcode" class="control-label">Postcode</label></td>
                            <td>  <asp:TextBox ID="txtPostcode" runat="server" class="form-control"></asp:TextBox>
                        ...
                        <tr>
                            <td>  <label for="txtPassword" class="control-label">Password</label></td>
                            <td>
     <asp:TextBox ID="txtPassWord" runat="server" class="form-control" TextMode="Password"></asp:TextBox>
                        ...
                        <tr>
                            <td>    <label for="ddlCountry" class="control-label">Country</label></td>
                            <td>
                    ...
                    <%--    <tr>
                        ...
                        <tr style="text-align:center">
                            ...
                            <td colspan="2"><asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-info font16" OnClick="btnSubmit_Click" ValidationGroup="Cust" />
   ...
   <asp:Panel ID="pnlFullDetails"  class="CSSTableGenerator" Width="100%" runat="server">
          <div id="BookRef" runat="server"  >
              <table style="border:1px solid; background: -webkit-gradient( linear, left top, left bottom, color-stop(0.05, #a9cae3), color-stop(1, #a9cae3) );">
                <tr>
                    ...
                    <td style="text-align:left"> <asp:TextBox ID="txtBookRef" style="color:black" runat="server" Width="281px"></asp:TextBox>
    ...
    margin: 0 auto;">
                    ...
                    <tr style="background-color: #EFF3FB;">
                        ...
                        <td style="border: thin solid #000000"><asp:Label ID="lblCurrency" runat="server" Text="Label"></asp:Label><asp:Label ID="txtPaidAmt" runat="server" ></asp:Label> (25% of total)</td>

                    </tr>
                    <tr style="background-color: rgba(149, 190, 222, 0.8) !important">
                        <td style="border: thin solid #000000;font-weight:bold">Balance Amount</td>
                        <td style="border: thin solid #000000"> <asp:Label ID="lblBalanceAmt" runat="server" Text="Label"></asp:Label> (75% of total) to be paid prior to <%Response.Write(Convert.ToDateTime(System.DateTime.Now).AddDays(-90).ToString("dddd, MMMM d, yyyy")); %></td>
