<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendtoairpay.aspx.cs" Inherits="posttoairpay" %>
    ...
    <%    
        ...
        string sCity = "NoCity";
        string sState = "NoState";
        string sCountry = "NoCountry";
        string sPincode = "226004" ;
        ...
        Response.Redirect("responsefromairpay.aspx");
...
<table width="500px;">
	...
	<tr>
		<td align="center" valign="middle">
			...
			<input type="hidden" name="buyerCity" value="NoCity"/>
			<input type="hidden" name="buyerState" value="NoState"/>
			<input type="hidden" name="buyerCountry" value="NoCountry"/>
			<input type="hidden" name="buyerPinCode" value="226004"/>
