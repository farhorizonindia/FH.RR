        ...
        <section>
           ...
           <asp:ScriptManager ID="scmgrLocation" runat="server">
            ...
            <div class="col-md-12 text-center White-Box" >
              ...
              <h2>Search Accomodations <span class=" pull-right" style="padding-top: 7px;"> <asp:LinkButton ID="LinkButton1" runat="server" CssClass="button-link" OnClick="LinkButton1_Click">Logout</asp:LinkButton></span></h2>
         ...
         <asp:UpdatePanel ID="updatepanel1" runat="server">
                <ContentTemplate>
                    ...
                    <table class="table table-striped">
                        <tr>
                            <td><asp:Label ID="lblLoginas" runat="server" Text=" Login as "></asp:Label> <asp:LinkButton ID="lnkLogin" runat="server" PostBackUrl="~/Cruise/booking/agentLogin.aspx" Font-Underline="True"> Agent</asp:LinkButton>
                            ...
                            <td>  <asp:RadioButtonList ID="rbtnSelectAccomtype" runat="server" OnSelectedIndexChanged="rbtnSelectAccomtype_SelectedIndexChanged" RepeatDirection="Horizontal" AutoPostBack="True">
...
<div id="OtherAccoms" runat="server">
   ...
   <table style="width: 80%;">
        <tr>
            <td> <asp:DropDownList ID="ddlAccomType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlAccomType_SelectedIndexChanged">
        </asp:DropDownList></td>
             <td>  <asp:DropDownList ID="ddlAccomodationName" runat="server">
        </asp:DropDownList></td>
             </tr>
</table>
        </div>
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" InitialValue="0" ValidationGroup="Search" ControlToValidate="ddlNoofrooms" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
          ...
          <tr>
           ...
           <tr>
                <td> <asp:Button ID="btnSearchOthAccom" runat="server" ValidationGroup="Search" Text="Check Availability" OnClick="btnSearchOthAccom_Click" /></td>
