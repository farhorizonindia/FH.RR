        ...
        <ContentTemplate>
            <div>
                ...
                <table id="inputsection" class="inputsection">
                    <tr>
                        <td class="filterLabel" style="width: 95px;">
                            Series Start Date
                        </td>
                        <td>
                        ...
                        <td class="filterLabel" style="padding-right: 0px;">
                            Agents
                        </td>
                        ...
                        <td class="filterLabel" style="width: 40px">
                            Nights
                        </td>
                        <td style="width: 49px">
                        ...
                        <td class="filterLabel" style="width: 22px">
                            Gap
                        </td>
                        <td style="width: 57px">
                        ...
                        <td class="filterLabel" style="width: 58px">
                            Departures
                        </td>
                        <td style="width: 68px">
