                    ...
                    <div id="divMain">
                        ...
                        <div id="rightCol" style="float: left; background-color: lightblue; height: 375px;">
                            <table id="inputsectionRight" class="inputsection" style="font-family: Verdana; font-size: x-small; padding-left: 10px;" cellspacing="2">
                                ...
                                <tr>
                                    <td class="labelcell">Passport Issue Date:</td>
                                    <td class="inputcell">
                                ...
                                <tr>
                                    <td class="labelcell">Passport Expiry Date:</td>
                                    <td class="inputcell">
                                ...
                                <tr>
                                    <td class="labelcell">Date Of Entry In India:</td>
                                    <td class="inputcell">
