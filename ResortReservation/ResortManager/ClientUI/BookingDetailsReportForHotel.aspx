<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookingDetailsReportForHotel.aspx.cs" Inherits="ClientUI_BookingDetailsReportForHotel" %>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlLocal" runat="server" Visible="false"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        '
                         <td>
                             <asp:Button ID="Button2" runat="server" Text="Clear All" OnClick="Button2_Click" /></td>
                    </tr>
            ...
            <div>
                <asp:DataGrid CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="PackageName" HeaderText="Package Name" Visible="false">
                            <ItemStyle CssClass="column" />
                            <HeaderStyle CssClass="columnHeader" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="Lagent" HeaderText="Ref Agent">
                            <ItemStyle CssClass="column" />
                            <HeaderStyle CssClass="columnHeader" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="PricePerPerson" DataFormatString="{0:0}" HeaderText="Rate Per Room">
                            <ItemStyle CssClass="column" />
                            <HeaderStyle CssClass="columnHeader" />
                        </asp:BoundColumn>
