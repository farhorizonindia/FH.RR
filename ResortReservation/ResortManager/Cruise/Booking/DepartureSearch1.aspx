...
<body>
<%--         <div runat="server"  class="loading" align="center" id="modalSending">
    <img src="../../images/loading1.gif" height="50px" width="50px" />--%>
</div> 
...
<<<<<<< HEAD
                        ...
                        <a class="navbar-brand agileits " id="logoheading" runat="server" href=" ">Resorts</a>
                ...
                AppendDataBoundItems="True" OnClientClick="javascript:return ShowSendingProgress();"
