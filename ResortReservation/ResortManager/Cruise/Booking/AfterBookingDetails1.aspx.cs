...
public partial class Cruise_Booking_AfterBookingDetails1 : System.Web.UI.Page
{
    DataTable Bookingdt;
    ...
    {
        ViewState["CustPass"] = txtPassWord.Value.Trim();
        sendMail();
    ...
    public void ClientRegister()
    {
        ...
        {
            blcus.action = "InsCustomers";
            blcus.Address1 = txtAddress1.Value;
            blcus.Address2 = txtaddress2.Value;
            blcus.City = txtCity.Value;
            Int32.TryParse(ddlCountry.SelectedValue, out CountryId);
            blcus.CountryId = CountryId;
            blcus.Email = txtMailAddress.Text.Trim();
            blcus.FirstName = txtFirstName.Value;
            blcus.LastName = txtLastName.Value;
            blcus.PostalCode = txtPostcode.Value;
            blcus.State = txtState.Value;
            blcus.Telephone = txtTelephone.Value.Trim();
            blcus.Password = ViewState["CustPass"].ToString();
            blcus.Title = ddltitle.SelectedItem.Text;
            blcus.PaymentMethod = txtPaymentMethod.Value.Trim();
