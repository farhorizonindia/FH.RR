...
<<<<<<< HEAD
        ...
        //    SqlDataAdapter adp = new SqlDataAdapter("select CssPath from tblagentmaster where agentid=" + agentid + "", strCon);
...
<<<<<<< HEAD
                ...
                if (Request["agentid"] != null)
                {
                    ...
                    lnkLogin.HRef= "agentLogin.aspx?agentid=" + Request["agentid"].ToString() + "";
                    lnkCustomerRegis.HRef = "../Masters/NewRegister.aspx?agentid=" + Request["agentid"].ToString() + "";
                }
                else
                {
...
<<<<<<< HEAD
            ...
            {
                Response.Redirect("Packagesearchresult.aspx?Package=" + ddlPackege.SelectedValue + "&Year=" + ddlYear.SelectedValue + "&month=" + ddlDates.SelectedItem + "&agentid=" + Session["agentid"] + "");
            }
            else
            {
...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
    ...
    public void fetchpackage()
    {
        ...
        DataTable dt = dlsearch.fetchallPackageHome();
        if (dt != null & dt.Rows.Count > 0)
        {
            ddlPackege.Items.Insert(0, "-Select Package-");
            ddlPackege.DataSource = dt;
    ...
    {
        DataTable dt = dlsearch.getavaialableYear();
        if (dt != null && dt.Rows.Count > 0)
        {
    ...
    private void loadmonths()
    {
        try
        {
            ...
            string sdate = "1/1/" + year;
            string edate = "12/31/" + year;

            DataTable dt = dlsearch.getavaialablemonthHome(Convert.ToDateTime(sdate),Convert.ToDateTime(edate) );
            int month = System.DateTime.Now.Month;
            ddlDates.Items.Insert(0, new ListItem("Select Month", "0"));
            var months = CultureInfo.CurrentCulture.DateTimeFormat.MonthNames;
            string getmonth = DateTime.Now.ToString("MMMM");
...
<<<<<<< HEAD
                    ...
                    if (Session["agentid"] != null)
                    {
                         url = "available.aspx?AId=" + Session["UserCode"].ToString() + "&AccomId=" + ddlAccomodationName.SelectedValue + "&pax=" + pax.ToString() + "&Checkin=" + checkin + "&Checkout=" + checkout + "&AccomName=" + ddlAccomodationName.SelectedItem.Text + "&agentid=" + Session["agentid"].ToString() + "";
                    }
                    else
                    {
                         url = "available.aspx?AId=" + Session["UserCode"].ToString() + "&AccomId=" + ddlAccomodationName.SelectedValue + "&pax=" + pax.ToString() + "&Checkin=" + checkin + "&Checkout=" + checkout + "&AccomName=" + ddlAccomodationName.SelectedItem.Text + "";
                    }
...
<<<<<<< HEAD
                    ...
                    if (Session["agentid"] != null)
                    {
                        url = "available.aspx?AId=248&AccomId=" + ddlAccomodationName.SelectedValue + "&pax=" + pax.ToString() + "&Checkin=" + checkin + "&Checkout=" + checkout + "&AccomName=" + ddlAccomodationName.SelectedItem.Text + "&agentid=" + Session["agentid"].ToString() + " ";
                    }
                    else
                    {
...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
    ...
    protected void ddlYear_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Int32 yearid = Convert.ToInt32(ddlYear.SelectedValue);

        string sdate = "1/1/" + yearid;
        string edate = "12/31/" + yearid;
