              ...
              <div class=" clearfix"> </div>
                ...
                <ContentTemplate>
                    ...
                    <table class="table table-striped">
                        <tr>
                            <td>
                                <asp:Label ID="lblLoginas" runat="server" Text=" Login as "></asp:Label> <asp:LinkButton ID="lnkLogin" runat="server" PostBackUrl="~/Cruise/booking/agentLogin.aspx" Font-Underline="True"> Agent</asp:LinkButton>
