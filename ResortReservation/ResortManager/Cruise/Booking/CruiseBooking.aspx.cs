...
public partial class Cruise_booking_CruiseBooking : BaseClass
{
...
<<<<<<< HEAD
        ...
        {
            csspath.Href = Session["CssPath"].ToString();
        }
...
<<<<<<< HEAD
                ...
                Session["chkoutdate"] = lblCheckOutDate.Text;
                ...
                foreach (DataRow dr in dtRoomsdata.Rows)
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            get = Convert.ToInt32(dr["Coordinates"].ToString().Split(',')[0]);
                            get1 = Convert.ToInt32(dr["Coordinates"].ToString().Split(',')[1]);
                            string path = Server.MapPath("inv/aspnet_imagemap1" + s + ".png");
                            FileInfo file = new FileInfo(path);
                            if (file.Exists)
                            {
                            ...
                            {
                                path = Server.MapPath("~/images/aspnet_imagemap1.png");
                            }
                            Bitmap bitMapIm = new
             System.Drawing.Bitmap(path);
                            Graphics graphicIm = Graphics.FromImage(bitMapIm);
                            ...
                            while (File.Exists(Server.MapPath("inv/aspnet_imagemap1" + getall + ".png")))
                            {
                                int count = 1;
                                Random rand1 = new Random();
                                long data1 = rand1.Next(10, 100000000);
                            ...
                            FileInfo file1 = new FileInfo(Server.MapPath("inv/aspnet_imagemap1" + getall + ".png"));


                            bitMapIm.Save((Server.MapPath("inv/aspnet_imagemap1" + getall + ".png")), ImageFormat.Png);
                            graphicIm.Dispose();
                            bitMapIm.Dispose();
                            if (Session["get"] != null)
                            {
                    ...
                    {
                        ImageMap1.ImageUrl = "inv/aspnet_imagemap1" + getall + ".png";
                    }
...
<<<<<<< HEAD
            ...
            //DataRow[] drr = dt.Select("PPRoomRate='0' ");
            //foreach (var rowr in drr)
            //    rowr.Delete();

            DataTable dt_copy = new DataTable();
            //dt.TableName = "CopyTable";
            dt_copy = dt.Copy();
            DataRow row = dt_copy.Rows[0];
...
<<<<<<< HEAD
                        ...
                        if (ddlCurrency.Text != "USD")
                        {
                            ...
                            currency(get12, ddlCurrency.Text);
                            sortedDT.Rows[i]["Price Per Person sharing"] = "USD " + Session["PricePerPersonsharing"];
                            string get22 = Convert.ToInt32(get2).ToString("##,0");
                            currency(get22, ddlCurrency.Text);
                           
                            sortedDT.Rows[i]["Price Per Person Single Use"] = "USD " + Session["PricePerPersonsingleuse"];
                        }
                        else
                        {
                            Session["PricePerPersonsharing"] = null;
                            Session["PricePerPersonsingleuse"] = null;
                            string get12 = Convert.ToInt32(get1).ToString("##,0");
                            string get22 = Convert.ToInt32(get2).ToString("##,0");
...
<<<<<<< HEAD
            ...
            else if(dt_copy != null)
            {
                if (dt_copy.Rows.Count > 0)
                {
                   
                    SessionServices.SaveSession<DataTable>("Rrate", dt_copy);
                   
                    for (int i = 0; i < dt_copy.Rows.Count; i++)
                    {
                        long get1 = Convert.ToInt32(dt_copy.Rows[i]["Price Per Person sharing"].ToString().Split('R')[1].Split('.')[0]);
                        long get2 = Convert.ToInt32(dt_copy.Rows[i]["Price Per Person Single Use"].ToString().Split('R')[1].Split('.')[0]);

                        if (ddlCurrency.Text != "USD")
                        {
                            string get12 = Convert.ToInt32(get1).ToString("##,0");
                            currency(get12, ddlCurrency.Text);
                            dt_copy.Rows[i]["Price Per Person sharing"] = "USD " + Session["PricePerPersonsharing"];
                            string get22 = Convert.ToInt32(get2).ToString("##,0");
                            currency(get22, ddlCurrency.Text);

                            dt_copy.Rows[i]["Price Per Person Single Use"] = "USD " + Session["PricePerPersonsingleuse"];
                        }
                        else
                        {
                            Session["PricePerPersonsharing"] = null;
                            ...
                            string get12 = Convert.ToInt32(get1).ToString("##,0");
                            string get22 = Convert.ToInt32(get2).ToString("##,0");
                            dt_copy.Rows[i]["Price Per Person sharing"] = "INR " + get12;
                            dt_copy.Rows[i]["Price Per Person Single Use"] = "INR " + Convert.ToInt32(dt_copy.Rows[i]["Price Per Person Single Use"].ToString().Split('R')[1].Split('.')[0]).ToString("##,0");

                        }
                       
                        lblTax.Text = "Prices are excluding Government Taxes";
                        Session["gettaxpercentage"] = dt_copy.Rows[i]["Tax Value"].ToString().Split('R')[1].Split('.')[0] + "%";
                    }
                    gdvRoomCategories.DataSource = dt_copy;
                    gdvRoomCategories.DataBind();
...
<<<<<<< HEAD
                if (ddlCurrency.Text != "USD")
                {
                    ...
                    lblgetTotal.Text = "USD " + ViewState["lblgetTotal"].ToString();
                }
                else
                {
...
<<<<<<< HEAD
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(arrr.ToString("##,0"), ddlCurrency.Text);
                                dr["pricewithouttax1"] = ViewState["pricewithouttax1"];

                                currency(Convert.ToDouble(arrr * 1).ToString("##,0"), ddlCurrency.Text);
                                dr["Total"] = ViewState["Total"];

                                double getdiscountamount = (Convert.ToDouble(arrr * 1) * (1 * Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;

                                currency((Convert.ToDouble(arrr * 1) - getdiscountamount).ToString("##,0"), ddlCurrency.Text);
                                dr["taxablepamt"] = ViewState["taxablepamt"];
                                ...
                                currency(Convert.ToDouble(tax).ToString("##,0"), ddlCurrency.Text);
                                dr["Tax1"] = ViewState["Tax1"];
                                double taxableprice = Math.Round(((arrr * Convert.ToInt32(1)) * Convert.ToDouble(view.ToTable().Rows[0][6].ToString().Split('R')[1])) / 100);

                                currency(Convert.ToDouble(taxableamnt + tax).ToString("##,0"), ddlCurrency.Text);
                                dr["Totalprice"] = ViewState["Totalprice"];
...
<<<<<<< HEAD
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(Convert.ToDouble(arrr * 3).ToString("##,0"), ddlCurrency.Text);
                                dr["Total"] = ViewState["Total"];
                                double getdiscountamount = (Convert.ToDouble(arrr * 3) * (3 * Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;

                                currency((Convert.ToDouble(arrr * 3) - getdiscountamount).ToString("##,0"), ddlCurrency.Text);
                                dr["taxablepamt"] = ViewState["taxablepamt"];
...
<<<<<<< HEAD
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(arrr1.ToString("##,0"), ddlCurrency.Text);
                                dr["pricewithouttax1"] = ViewState["pricewithouttax1"];

                                currency(Convert.ToDouble(arrr1 * Convert.ToInt32(2)).ToString("##,0"), ddlCurrency.Text);
                                dr["Total"] = ViewState["Total"];
                                double getdiscountamount = (Convert.ToDouble(arrr1 * 2) * (2 * Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;

                                currency((Convert.ToDouble(arrr1 * 2) - getdiscountamount).ToString("##,0"), ddlCurrency.Text);
                                dr["taxablepamt"] = ViewState["taxablepamt"];
                    ...
                    else
                    {
                        ...
                        if (ddlCurrency.Text != "USD")
                        {
                            ...
                            currency(Convert.ToDouble(arrr1 * Convert.ToInt32(view.ToTable().Rows[0][10].ToString())).ToString("##,0"), ddlCurrency.Text);
                            dr["Total"] = ViewState["Total"];
                            ...
                            currency((Convert.ToDouble(arrr1 * Convert.ToInt32(view.ToTable().Rows[0][10].ToString())) - getdiscountamount).ToString("##,0"), ddlCurrency.Text);
                            dr["taxablepamt"] = ViewState["taxablepamt"];
...
<<<<<<< HEAD
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(Convert.ToDouble(Convert.ToDouble(taxableamnt + tax)).ToString("##,0"), ddlCurrency.Text);
                                dr["Totalprice"] = ViewState["Totalprice"];
                                dr["texableprice"] = Convert.ToDouble(taxableprice).ToString("##,0");
                            }
                            else
                    ...
                    if (Session["getbedconfig"] != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                double getdiscountamount = (Convert.ToDouble(arrr1 * 2) * (Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;
...
<<<<<<< HEAD
                            ...
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(Convert.ToDouble(arrr * Convert.ToInt32(1)).ToString("##,0"), ddlCurrency.Text);
                                dr["Total"] = ViewState["Total"];
                                double getdiscountamount = (Convert.ToDouble(arrr * 1) * (1 * Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;
...
<<<<<<< HEAD
                            if (ddlCurrency.Text != "USD")
                            {
                                ...
                                currency(Convert.ToDouble(arrr * Convert.ToInt32(3)).ToString("##,0"), ddlCurrency.Text);
                                dr["Total"] = ViewState["Total"];
                                double getdiscountamount = (Convert.ToDouble(arrr * 3) * (3 * Convert.ToDouble(Session["getdiscountvalue"].ToString()))) / 100;
    ...
    protected void ImageMap1_Click(object sender, ImageMapEventArgs e)
    {
        try
        {
            ...
            if (gdvRoomCategories.Rows.Count > 1)
            {
                ...
                hfRoomId.Value = e.PostBackValue.ToString();
                blsr.RoomId = hfRoomId.Value;
                Session["Cabinno"]= hfRoomId.Value;
                blsr.PackageId = Session["PackageId"].ToString();
                ...
                if (checkin >= Convert.ToDateTime(dd))
                {
                    if (dt.Rows.Count >= 4 && hfRoomId.Value == "109" || dt.Rows.Count >= 4 && hfRoomId.Value == "110")
                    {
                        roomCatId = 15;
                    }
                    else
                    {
                        if (hfRoomId.Value == "109" || hfRoomId.Value == "110")
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Showstatus", "javascript:alert('Cabin cannot be selected as rates have not been mapped. Please send request to your sales representative to add rates.')", true);
                            return;
                        }
...
<<<<<<< HEAD
                        ...
                        ViewState["taxablepamt"] = value;
                        ViewState["Tax1"] = value;
...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
                ...
                {
                    Session["PricePerPersonsharing"] = "";
                    Session["PricePerPersonsingleuse"] = "";

                    ViewState["pricewithouttax1"] = "";
                    ViewState["Total"] = "";
                    ViewState["taxablepamt"] = "";
                    ViewState["Tax1"] = "";
                    ViewState["Totalprice"] = "";
                    ViewState["lblgetTotal"] = "";
                }
            }
...
<<<<<<< HEAD
            ...
            if (ddlCurrency.Text != "USD")
            {
                lblgetTotal.Text = ""; decimal total = 0; decimal total1 = 0;
                int LoopInsertStatus = 0;
                for (int LoopCounter = 0; LoopCounter < GridRoomPaxDetail.Rows.Count; LoopCounter++)
                {
                    Label lbPrice = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[3].FindControl("Price");
                    currency(lbPrice.Text, ddlCurrency.Text);
                    lbPrice.Text = ViewState["pricewithouttax1"].ToString();

                    Label lbTotal = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[4].FindControl("Total");
                    currency(lbTotal.Text, ddlCurrency.Text);
                    lbTotal.Text = ViewState["Total"].ToString();

                    Label lbTaxableAmnt = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[6].FindControl("lblTax11");
                    currency(lbTaxableAmnt.Text, ddlCurrency.Text);
                    lbTaxableAmnt.Text = ViewState["taxablepamt"].ToString();

                    Label lbTax = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[7].FindControl("lblTax1123");
                    currency(lbTax.Text, ddlCurrency.Text);
                    lbTax.Text = ViewState["Tax1"].ToString();

                    Label lbTotalPrice = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[8].FindControl("lblTotalprice12");
                    currency(lbTotalPrice.Text, ddlCurrency.Text);
                    lbTotalPrice.Text = ViewState["Totalprice"].ToString();

                    if (lbTotalPrice.Text != "")
                    {
                        total = Convert.ToDecimal(lbTotalPrice.Text);
                        total1 += total;

                        lblgetTotal.Text = "USD " + total1.ToString();
                    }
                    LoopInsertStatus++;
...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
            ...
            {
                int LoopInsertStatus = 0; decimal total = 0; decimal total1 = 0;
                for (int LoopCounter = 0; LoopCounter < GridRoomPaxDetail.Rows.Count; LoopCounter++)
                {
                    currency1();
                    decimal dollar = Convert.ToDecimal(Session["Dollar"]);
                    Label lbPrice = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[3].FindControl("Price");
                    decimal ss = Convert.ToDecimal(lbPrice.Text);
                    decimal ss1 = ss * dollar;
                    lbPrice.Text = ss1.ToString("##.#");

                    Label lbTotal = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[4].FindControl("Total");
                    decimal tt = Convert.ToDecimal(lbTotal.Text);
                    decimal tt1 = tt * dollar;
                    lbTotal.Text = tt1.ToString("##.#");

                    Label lbTaxableAmnt = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[6].FindControl("lblTax11");
                    decimal tx = Convert.ToDecimal(lbTaxableAmnt.Text);
                    decimal tx1 = tx * dollar;
                    lbTaxableAmnt.Text = tx1.ToString("##.#");

                    Label lbTax = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[7].FindControl("lblTax1123");
                    decimal ttx = Convert.ToDecimal(lbTax.Text);
                    decimal ttx1 = ttx * dollar;
                    lbTax.Text = ttx1.ToString("##.#");

                    Label lbTotalPrice = (Label)GridRoomPaxDetail.Rows[LoopCounter].Cells[8].FindControl("lblTotalprice12");
                    decimal tpr = Convert.ToDecimal(lbTotalPrice.Text);
                    decimal tpr1 = tpr * dollar;
                    lbTotalPrice.Text = tpr1.ToString("##.#");

                    total = Convert.ToDecimal(lbTotalPrice.Text);
                    total1 += total;

                    lblgetTotal.Text = "INR " + total1.ToString();
