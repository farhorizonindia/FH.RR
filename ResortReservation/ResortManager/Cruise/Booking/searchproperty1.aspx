<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchProperty1.aspx.cs" Inherits="Cruise_Booking_searchproperty1" %>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <nav class="navbar navbar-default  aits wow bounceInUp agileits ">
                <div class="container">
                    ...
                    <div class="navbar-header agileits ">
                        ...
                        <a class="navbar-brand agileits headerTextFont" href="searchproperty1.aspx">Booking System</a>
                    </div>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-100205500-2"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag() { dataLayer.push(arguments); }
            gtag('js', new Date());

            gtag('config', 'UA-100205500-2');
        </script>
