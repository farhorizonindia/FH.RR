                                                            ...
                                                            <option>6</option>
                                                                    ...
                                                                    <%# Session["Amt"] = DataBinder.Eval(Container.DataItem, "Amt") %></div>
                                                                        ...
                                                                        <% if (ddlCurrency.Text != "USD")
                                                                            {
                                                                                currency(Session["Amt"].ToString(), "INR");

                                                                                Response.Write(" <p style='font-size: 24px;' font-family: 'Montserrat', sans-serif;' class='text-right'><strong>USD " +  ViewState["Comman"] + " </strong></p>");
                                                                            }
                                                                            else
                                                                            {
                                                                               
                                                                                Response.Write("  <p style='font-size: 24px;' font-family: 'Montserrat', sans-serif;' class='text-right'><strong>INR "  +  Session["Amt"].ToString()  + " </strong></p>");
