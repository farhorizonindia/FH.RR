...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
    ...
    private void calculateall(DataTable dt)
    {
        ...
        {
            lblGross.Text = invoiceamount.ToString("##,0");
            currency(invoiceamount.ToString("##,0"), "INR");
            lblGross.Text = Session["comman"].ToString();

            Label3.Text = TaxAmount.ToString("##,0");
            currency(TaxAmount.ToString("##,0"), "INR");
            Label3.Text = Session["comman"].ToString();

            lblgetTotal.Text = gross.ToString("##,0");
            currency(gross.ToString("##,0"), "INR");
            lblgetTotal.Text = Session["comman"].ToString();
        }
        else
        {
            lblGross.Text = invoiceamount.ToString("##,0");
...
<<<<<<< HEAD
    ...
    public void Sendfinalmail()
    {
        try
        {
            ...
            {
                mail.Bcc.Add(Session["AgentEmailId"].ToString());
            }
            //mail.CC.Add(ccEmail);
            if (Session["geteamil"] != null && Session["geteamil"] != "")
            {
 ...
 if (Session["guest"] != null)
            {
                ...
                sb.Append("<div>");
                sb.Append("Username: " + Convert.ToString(Session["guest"]));
                sb.Append("</div>");

                sb.Append("<div>");
                sb.Append("Password: " + Convert.ToString(Session["userpass"]));
                sb.Append("</div>");
		  ...
		  if (Session["AccomId"] != "" && Session["AccomId"] != null)
            ...
            // mail.CC.Add("reservations@adventureresortscruises.com");
            mail.Attachments.Add(new Attachment(Server.MapPath("inv/" + lbInvoiceNO.Text + "Invoice.pdf")));
            //mail.Attachments.Add(new Attachment(Server.MapPath("inv/" + lbInvoiceNO.Text + ".pdf")));
...
<<<<<<< HEAD
                    ...
                    if (Session["SetCurrency"].ToString() == "INR")
                    {
                        ...
                        currency(lblTotPaid.Text, "INR");
                        lblTotPaid.Text = Session["comman"].ToString();
                    }
                    else
                    {
                        lblTotPaid.Text = Convert.ToInt32(lblTotPaid.Text).ToString("##,0");
...
<<<<<<< HEAD
                    if (Session["SetCurrency"].ToString() == "INR")
                    {
                        ...
                        currency(lblTotPaid.Text, "INR");
                        lblTotPaid.Text = Session["comman"].ToString();
                        //lblttlamnt.Text = "Total Amout Paid (In USD)";
                        //lblttldue.Text = "Total Due (In USD)";
                    }
                    else
                    {
                        lblTotPaid.Text = Convert.ToInt32(lblTotPaid.Text).ToString("##,0");
...
<<<<<<< HEAD
                    ...
                    {
                        lblgetTotal.Text = Convert.ToInt32(totalAmount1.ToString()).ToString("##,0");
                        currency(Convert.ToInt32(totalAmount1.ToString()).ToString("##,0"), "INR");
                        lblgetTotal.Text = Session["comman"].ToString();

                        lblGross.Text = Convert.ToInt32(totagross).ToString("##,0");
                        currency(Convert.ToInt32(totagross).ToString("##,0"), "INR");
                        lblGross.Text = Session["comman"].ToString();
                    }
                    else
                    {
...
<<<<<<< HEAD
                        ...
                        if (Session["SetCurrency"].ToString() == "INR")
                        {
                            ...
                            currency(Convert.ToInt32(totdiscount).ToString("##,0"), "INR");
                            lblDiscount.Text = Session["comman"].ToString();
                        }
                        else
                        {
                            lblDiscount.Text = Convert.ToInt32(totdiscount).ToString("##,0");
...
<<<<<<< HEAD
                    ...
                    if (Session["SetCurrency"].ToString() == "INR")
                    {
                       decimal ss= Convert.ToDecimal(lblGross.Text);

                        string sd = ss.ToString("#.##");
                        sd = sd.Remove(sd.LastIndexOf("."));
                        lbRuppeeinwords.Text = GF.NumbersToWords(Convert.ToInt32(sd.Replace(",", "")));

                        var res = "USD" + lbRuppeeinwords.Text.Substring(3);
                        lbRuppeeinwords.Text = res;
...
>>>>>>> 06df147e7f6e76b3ddcb27473f8305164d96b955
    ...
    protected void gdvCruiseRooms_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                if (Session["SetCurrency"].ToString() == "INR")
                {
                    e.Row.Cells[4].Text = e.Row.Cells[4].Text.Replace("Rate Per Person(INR)", "Rate Per Person(USD)");
                    e.Row.Cells[5].Text = e.Row.Cells[5].Text.Replace("Gross Amount(INR)", "Gross Amount(USD)");
                }
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (Session["SetCurrency"].ToString() == "INR")
                {
                    ...
                    string rpp = e.Row.Cells[4].Text;
                    currency(rpp, "INR");
                    e.Row.Cells[4].Text = Session["comman"].ToString();

                    string ga = e.Row.Cells[5].Text;
                    currency(ga, "INR");
                    e.Row.Cells[5].Text = Session["comman"].ToString();
                }
    ...
    protected void btnBack_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("SearchProperty.aspx?agentid=" + Request["agentid"].ToString() + "");
        }
        else
        {
