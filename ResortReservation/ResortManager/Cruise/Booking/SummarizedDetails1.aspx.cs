...
public partial class Cruise_Booking_SummarizedDetails1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                PackageDesc(PackId);
                Session["Redirection"] = "SummarizedDetails1.aspx";
    ...
    public void ClientRegister1()
    {
        try
        {
            ...
            // blcus.Password = ViewState["CustPass"].ToString();
            // Session["userpass"] = ViewState["CustPass"].ToString();
            blcus.Password = Session["Code"].ToString();
            Session["userpass"] = Session["Code"].ToString();
