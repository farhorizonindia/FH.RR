...
public partial class Cruise_Booking_HotelBooking1 : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string redurl = "AfterBookingDetails1.aspx?AccomName=" + Request.QueryString["AccomName"].ToString() + "";
