...
<<<<<<< HEAD
    ...
    public void sendMail_Proceed(string bookingno, string dateofbooking, string Name)
    {
        ...
        try
        {
            ...
            mail.To.Add(txtMailAddress.Text.Trim());
            string ccEmail = ConfigurationManager.AppSettings["ccEmail"];
            ccEmail = "amit.rana475@gmail.com";
            mail.Subject = "Booking Info";

            StringBuilder sb = new StringBuilder();
            sb.Append("<div>");
            sb.Append("<div> Booking No.-  " + bookingno + ",</div> <div><br/></div> ");
            sb.Append("<div> Date of Booking.-  " + dateofbooking + ",</div> <div><br/></div> ");
            sb.Append("<div> Name -  " + Name + "</div> <div><br/></div> ");
            sb.Append("<div> Email -  " + txtMailAddress.Text.Trim() + "</div> <div><br/></div> ");
