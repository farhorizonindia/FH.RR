            ...
            <ContentTemplate>
                <div>
                    <table id="filtersection" class="filtersection" style="font-size: small; font-family: Verdana;">
                        <tr>
                            <td align="left" style="height: 18px; font-size: 8pt; width: 120px; text-align: left;">Accomodation Type:</td>
                            ...
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Accomodation:</td>
                    ...
                    <div id="gridsection" class="gridsection">
                        <asp:DataGrid ID="dgRooms" runat="server" AutoGenerateColumns="False"
                            ...
                            Width="907px" TabIndex="3" AllowPaging="True" OnPageIndexChanged="dgRooms_PageIndexChanged" Height="231px" Font-Size="Small" OnItemCommand="dgRooms_ItemCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Status">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnlactive" Text='<%#Eval("ActiveStatus") %>' CommandArgument='<%#Eval("RoomNo") %>' CommandName='<%#Eval("AccomodationId") %>' runat="server"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
                    ...
                    <table id="inputsection" class="inputsection">
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">&nbsp;</td>
                            <td class="auto-style1">
                                <asp:Label ID="lblStatus" runat="server" ForeColor="Red"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Room Category:</td>
                            <td class="auto-style1">
                        ...
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Room Type:</td>
                            ...
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Default Beds:
                            </td>
                        ...
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Floor:</td>
                            <td class="auto-style3">
                                <asp:DropDownList CssClass="select" ID="ddlFloors" runat="server" Width="155px" TabIndex="6" Font-Size="8pt">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Room No:</td>
                            <td class="auto-style3">
                                <asp:TextBox CssClass="input" ID="txtRoomNo" runat="server" MaxLength="15" TabIndex="7" Font-Size="8pt"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="font-size: 8pt; width: 91px; height: 18px; text-align: left">Extra Beds:</td>
                            <td class="auto-style4">
                                <asp:DropDownList CssClass="select" ID="ddlExtraBeds" runat="server" Width="95px" TabIndex="8" AutoPostBack="True" OnSelectedIndexChanged="ddlExtraBeds_SelectedIndexChanged" Font-Size="8pt">
                                </asp:DropDownList></td>
                            <td style="font-size: 8pt; width: 91px; height: 18px; text-align: left">Extra Bed Rate:</td>
                            <td>
                                <asp:TextBox CssClass="input" ID="txtExtraBedRate" runat="server" Enabled="False" TabIndex="9" Font-Size="8pt"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="height: 18px; font-size: 8pt; width: 91px; text-align: left;">Total
                No Of Beds:</td>
                            <td class="auto-style3">
                            ...
                            <td style="height: 18px;">
                                <asp:DropDownList CssClass="select" ID="ddlConvert" runat="server" Width="95px" TabIndex="11" AutoPostBack="True" OnSelectedIndexChanged="ddlExtraBeds_SelectedIndexChanged" Font-Size="8pt">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td style="vertical-align: top; font-size: 8pt; width: 91px; height: 18px; text-align: left;">Description:</td>
                    ...
                    <table id="buttonsection" class="buttonsection">
                        <tr>
                            ...
                            <td style="width: 74px; height: 26px;">
                                <asp:Button CssClass="appbutton" ID="btnHide" runat="server" Text="Inactive"
                                    Width="65px" TabIndex="15" OnClick="btnHide_Click" /></td>
                        </tr>
                    </table>
