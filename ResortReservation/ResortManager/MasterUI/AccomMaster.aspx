            ...
            <asp:UpdatePanel ID="pnlAccomMaster" runat="server">
                <ContentTemplate>
                    ...
                    <div id="gridsection" class="gridsection">
                        <asp:DataGrid ID="dgAccomodations" runat="server" AutoGenerateColumns="False" BorderStyle="Ridge"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="AccomPolicyUrl" HeaderText="URL"></asp:BoundColumn>
                    ...
                    <table id="inputsection" class="inputsection">
                        <tr>
                            <td class="labelcell">Accomodation:
                            </td>
                            <td class="inputcell">
                        ...
                        <tr>
                            <td class="labelcell">Accomodation Initial:
                            </td>
                            <td class="inputcell">
                        ...
                        <tr>
                            <td class="labelcell">Accomodation Policy Url:
                            </td>
                            <td class="inputcell">
                                <asp:TextBox CssClass="input" ID="txtAccomPolicyUrl" runat="server" MaxLength="100" TabIndex="5"
                    ...
                    <table id="buttonsection" class="buttonsection">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnInactive" runat="server" CssClass="appbutton"  TabIndex="12" Text="Inactive" Width="65px" Visible="false" OnClick="btnInactive_Click" /></td>
                        </tr>
                    </table>
